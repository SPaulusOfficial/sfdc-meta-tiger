...
namespace MetaTiger.Metadata{
    class metaBusinessProcess:MetaCustomObjectBase {

		Dictionary<string, List<_BusinessProcess>> m_dictionaryObject;
        
		public metaBusinessProcess(){
			this.m_metaname = MetaConstants.BusinessProcess;

			this.m_list = new List<String>();
			this.m_mapMetaObject = new Dictionary<String,String>();
			this.m_dictionaryObject = new Dictionary<string, List<_BusinessProcess>>();
		} 
		...
		public override void doMerge(){
			foreach(KeyValuePair<string, List<_BusinessProcess>> dictionaryObject in m_dictionaryObject)
			{
				 ...
				 m_mergeObject.BusinessProcesses = dictionaryObject.Value;
			}
		}
